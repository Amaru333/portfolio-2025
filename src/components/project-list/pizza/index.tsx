...
function Pizza() {
  const stacks = ["React Native", "Expo", "Node.js", "Express", "MongoDB", "Redux Toolkit"];
  return (
    <div className="w-full max-w-screen-xl mx-auto min-h-screen py-12">
      <ProjectHeader title="Pizza" timeline="July 2022 - August 2022" />
      <ProjectImageCarousel folder="pizza" count={6} />
      ...
      <div className="text-slate-800 dark:text-slate-200">
        <p>
          A basic mobile app that allows users to order pizzas from a restaurant. Users can sign up
          or log in through email using One Time Password (OTP), eliminating the need for passwords.
        ...
        <div className="mt-2">
          ...
          <ul className="list-disc list-inside mt-2">
            <li>
              Developed RESTful APIs for user authentication, menu fetching, order placement, and so
              on.
            </li>
        ...
        <div className="flex gap-x-2 my-6">
          <Button variant="outline" asChild>
            <a href="https://github.com/Amaru333/pizza" target="_blank" rel="noopener noreferrer">
          ...
          <Button variant="outline" asChild>
            <a
              href="https://github.com/Amaru333/pizza_backend"
              target="_blank"
